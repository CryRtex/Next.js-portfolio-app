      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
            / / I am your average developer
          </p>
          <p className='py-2 text-gray-600'>
            I spent 7 years intermittently on software.
            . I have always had a knack for
            technology and working with computers. 
            In 2017 I started working
          ...
          <p className='py-2 text-gray-600'>
            ...
            now spending my time building projects with Next JS, Next UI Firebase, Server Attempt Tech and
